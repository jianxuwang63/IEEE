...
\thanks{This research is supported by the Natural Science Foundation of Hunan Province 2024JJ6303, the Research Foundation of the Education Department of Hunan Province 23B0056, Hunan Phttps://www.overleaf.com/project/697c4754a4e721315d42cc78/doc/6a06e7404b019111880fe70a/downloadrovincial NSF Key Project 2025JJ30008, Hunan Furong Program High-Level Health Talent Support Project 20241226039 and High-Level Talent Support Program of Hunan Cancer Hospital 202507311010. (Corresponding author: Xuewei Cheng.)}
...
\textcolor{red}{Is it necessary to illustrate that cost-sensitive learning (CSL) is widely applied in research on imbalanced data? Besides, I think the content in the related work section is relatively concise. Are there any parts that need further elaboration?}
...
Conformal risk control (CRC) \cite{bates2021distribution, angelopoulos2022conformal} offers a complementary, post-hoc framework that provides distribution-free guarantees on user-defined risk metrics. CRC has been applied in medical imaging to enable reliable human-in-the-loop workflows \cite{dvijotham2023enhancing}. Inspired by CRC, we incorporate risk control and FNR control 
into the threshold calibration of selective classification, 
enabling SelectiveNet to simultaneously learn ambiguous input 
representations while providing rigorous, distribution-free 
guarantees on clinical safety bounds.
