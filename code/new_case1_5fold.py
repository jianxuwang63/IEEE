...
def main():
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(X, y)):
        ...
        for epoch in range(Config.epochs):
            ...
            # 依然计算验证 Loss 供观察，但不再基于它保存 Best Model
